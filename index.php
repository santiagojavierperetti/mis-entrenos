...
<main>
    <header>
        ...
        <p>
            Copiá este archivo completo para asegurarte de tener la misma interfaz con zona de drag & drop.
            Podés arrastrar y soltar el archivo desde tu computadora o seleccionarlo manualmente.
        </p>
    </header>
