...
<main>
    <header class="page-header">
        ...
        <p>
            Podés arrastrar y soltar el archivo desde tu computadora o seleccionarlo.
        </p>
    </header>
    ...
    <form id="upload-form" class="section-card" action="procesar.php" method="post" enctype="multipart/form-data" novalidate>
        <div class="upload-area">
            ...
            <div class="upload-dropzone" role="button" tabindex="0"
                ...
                <span class="dropzone-title">Cargá un archivo FIT</span>
                <span class="dropzone-subtitle">Arrastrá y soltá uno, o hacé clic para elegirlo desde tu dispositivo.</span>
        ...
        <p class="form-hint">
            Aceptamos únicamente archivos con extensión <code>.fit</code> de hasta <strong>20&nbsp;MB</strong>.
        </p>
